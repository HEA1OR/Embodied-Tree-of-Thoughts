...
class KeypointProposer:
    ...
    def get_keypoints(self, rgb, points, masks):
        ...
        print('exclude keypoints that are outside of the workspace')
        print('candidate_keypoints', candidate_keypoints)
        print('candidate_pixels', candidate_pixels)
        print('candidate_rigid_group_ids', candidate_rigid_group_ids)
        ...
        print('merge close points by clustering in cartesian space')
        print('candidate_keypoints', candidate_keypoints)
        print('candidate_pixels', candidate_pixels)
        print('candidate_rigid_group_ids', candidate_rigid_group_ids)
        ...
        print('sort candidates by locations')
        print('candidate_keypoints', candidate_keypoints)
        print('candidate_pixels', candidate_pixels)
        print('candidate_rigid_group_ids', candidate_rigid_group_ids)
        ...
        print('project keypoints to image space')
        print('projected', projected)
        return candidate_keypoints, projected

    def _preprocess(self, rgb, points, masks):
        # convert masks to binary masks
        masks = [masks.cpu().numpy() == uid for uid in np.unique(masks.cpu().numpy())]
        ...
        return transformed_rgb, rgb.cpu().numpy(), points, masks, shape_info
