...
#     payload = prepare_inputs_multi_image(message, image)
#     response = requests.post("https://api.zhizengzeng.com/v1/chat/completions", headers=headers, json=payload)  #    https://api.openai.com
